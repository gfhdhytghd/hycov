...
record_windows_and_move_to_mission_control() {
    ...
    local layout_output
    layout_output=$(layout_mission_control "$curr_monitor_width" "$curr_monitor_height" "$window_count" --padding 8 --bases 2x4 --force "3:2,1;4:2,2;5:3,2;6:3,3;7:4,3;8:4,4;9:5,4")
